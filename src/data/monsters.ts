...
export interface MonsterTemplate {
  ...
  speed?: number;
  /** Individual treasure type carried on the body, e.g. "Q", "Q×3", "P,Q×2". "none" = nothing. */
  individual?: string;
  /** Lair treasure type letter (DMG Table 5), e.g. "D", "H". "none" = no lair treasure. */
  lairType?: string;
}
...
export const MONSTERS: MonsterTemplate[] = [
  ...
  // ── HUMANOIDS ────────────────────────────────────────────────────────────────
  { name: 'Kobold',               hd: '1/2',   hp:  2, ac:  7, thac0: 20, attacks: '1',   damage: '1d4',             mv: '6',           tags: ['humanoid'], speed: 2,  individual: 'Q',     lairType: 'J' },
  { name: 'Goblin',               hd: '1-1',   hp:  4, ac:  6, thac0: 20, attacks: '1',   damage: '1d6',             mv: '6',           tags: ['humanoid'], speed: 3,  individual: 'Q×2',   lairType: 'C' },
  { name: 'Orc',                  hd: '1',     hp:  5, ac:  6, thac0: 19, attacks: '1',   damage: '1d8',             mv: '9',           tags: ['humanoid'], speed: 7,  individual: 'Q×5',   lairType: 'D' },
  { name: 'Hobgoblin',            hd: '1+1',   hp:  6, ac:  5, thac0: 18, attacks: '1',   damage: '1d8',             mv: '9',           tags: ['humanoid'], speed: 3,  individual: 'P,Q',   lairType: 'D' },
  { name: 'Gnoll',                hd: '2',     hp:  9, ac:  5, thac0: 19, attacks: '1',   damage: '2d4',             mv: '9',           tags: ['humanoid'], speed: 7,  individual: 'Q×3',   lairType: 'D' },
  { name: 'Gnoll (Flind)',         hd: '3',     hp: 14, ac:  5, thac0: 17, attacks: '3',   damage: '1d6+1/1d6+1/1d4+1', mv: '9',       tags: ['humanoid'], speed: 7,  individual: 'Q×3',   lairType: 'D',  notes: 'flindbar: disarm or stun (save vs. paralysis)' },
  { name: 'Troglodyte',           hd: '2',     hp:  9, ac:  5, thac0: 19, attacks: '3',   damage: '1d4/1d4/1d4',    mv: '12',          tags: ['humanoid'],            individual: 'none',  lairType: 'A',  notes: 'stench: save vs. poison or -2 to hit/damage; chameleon skin' },
  { name: 'Lizard Man',           hd: '2+1',   hp: 10, ac:  5, thac0: 19, attacks: '2',   damage: '1d2+1/2d4',      mv: '6, Sw 12',    tags: ['humanoid'], speed: 6,  individual: 'none',  lairType: 'D' },
  { name: 'Kuo-toa',              hd: '2',     hp:  9, ac:  4, thac0: 17, attacks: '1',   damage: '2d4',             mv: '9, Sw 18',    tags: ['humanoid'], speed: 6,  individual: 'P×2,Q', lairType: 'D',  notes: 'immune to illusion; sticky hands; lightning; 1-in-4 chance to pin shield' },
  { name: 'Bugbear',              hd: '3+1',   hp: 15, ac:  5, thac0: 17, attacks: '1',   damage: '2d4+1',           mv: '9',           tags: ['humanoid'], speed: 7,  individual: 'R,S',   lairType: 'B' },
  { name: 'Drow',                 hd: '1+1',   hp:  6, ac:  4, thac0: 18, attacks: '1',   damage: '1d4',             mv: '12',          tags: ['humanoid'], speed: 3,  individual: 'U',     lairType: 'U',  notes: 'spell abilities (darkness, faerie fire, levitate); light sensitivity; +2 save vs. magic' },
  { name: 'Sahuagin',             hd: '2+2',   hp: 11, ac:  5, thac0: 19, attacks: '4',   damage: '1d4/1d4/1d4/1d6 or weapon', mv: '12, Sw 24', tags: ['humanoid'], speed: 6, individual: 'Q,P', lairType: 'D' },
  ...
  { name: 'Ghoul',                hd: '2',     hp:  9, ac:  6, thac0: 19, attacks: '3',   damage: '1d3/1d3/1d6',    mv: '9',           tags: ['undead'], individual: 'none', lairType: 'B',    notes: 'paralysis on hit (save vs. paralysis); elves immune' },
  { name: 'Shadow',               hd: '3+3',   hp: 17, ac:  7, thac0: 17, attacks: '1',   damage: '1d4+Str drain',  mv: '12',          tags: ['undead'], individual: 'none', lairType: 'F',    notes: 'Str drain 1 per hit; hit only by magic weapons; not affected by turn undead as normal' },
  { name: 'Ghast',                hd: '4',     hp: 18, ac:  4, thac0: 17, attacks: '3',   damage: '1d4/1d4/1d6',    mv: '15',          tags: ['undead'], individual: 'none', lairType: 'B',    notes: 'stench (save vs. poison); paralysis (save vs. paralysis); not affected by turn undead normally' },
  { name: 'Wight',                hd: '4+3',   hp: 21, ac:  5, thac0: 15, attacks: '1',   damage: 'energy drain',   mv: '12',          tags: ['undead'], individual: 'none', lairType: 'B',    notes: 'energy drain 1 level; hit only by silver or magic weapons' },
  { name: 'Wraith',               hd: '5+3',   hp: 26, ac:  4, thac0: 15, attacks: '1',   damage: 'energy drain',   mv: '12, Fl 24',   tags: ['undead'], individual: 'none', lairType: 'E',    notes: 'energy drain 1 level; hit only by silver/+1 weapons' },
  { name: 'Spectre',              hd: '7+3',   hp: 35, ac:  2, thac0: 13, attacks: '1',   damage: 'energy drain ×2', mv: '15, Fl 30',  tags: ['undead'], individual: 'none', lairType: 'E',    notes: 'drains 2 levels per hit; hit only by +1 or better weapons' },
  { name: 'Mummy',                hd: '6+3',   hp: 30, ac:  3, thac0: 13, attacks: '1',   damage: '1d12+disease',   mv: '6',           tags: ['undead'], individual: 'none', lairType: 'F',    notes: 'rotting disease; fear gaze (save vs. spell); vulnerable to fire; +1 weapons to hit' },
  { name: 'Skeleton Warrior',     hd: '9+',    hp: 45, ac:  2, thac0: 11, attacks: '1',   damage: 'by weapon',      mv: '12',          tags: ['undead'], individual: 'none', lairType: 'E',    notes: 'elite fighter; fearless; tiara binds it; turns as lich; immune: non-magic weapons' },
  { name: 'Vampire',              hd: '8+3',   hp: 40, ac:  1, thac0: 13, attacks: '2',   damage: '1d6+4/energy drain', mv: '12, Fl 18', tags: ['undead'], individual: 'none', lairType: 'F', notes: 'drains 2 levels; charm gaze; regenerates 3hp/rd; +1 weapons to hit' },
  { name: 'Lich',                 hd: '11+',   hp: 55, ac:  0, thac0:  7, attacks: '1',   damage: '1d10+paralysis', mv: '6',           tags: ['undead'], individual: 'none', lairType: 'G',    notes: 'paralysis touch; fear gaze (20\'); immune: charm, sleep, cold; powerful spellcaster' },
  { name: 'Banshee',              hd: '7',     hp: 32, ac:  0, thac0: 13, attacks: '1',   damage: '1d8',             mv: '15',          tags: ['undead'], individual: 'none', lairType: 'E',    notes: 'wail: all within 30\' die (save vs. death); hit only by +1 or better weapons' },
  { name: 'Death Knight',         hd: '12',    hp: 54, ac: -4, thac0:  7, attacks: '1',   damage: 'by weapon+12',   mv: '12',          tags: ['undead'], individual: 'none', lairType: 'H',    notes: 'fireball 11d6; immune: cold, electricity, fear, non-magic weapons; spell abilities (F9/MU15)' },

  // ── GIANT-KIND ───────────────────────────────────────────────────────────────
  { name: 'Ogre',                 hd: '4+1',   hp: 19, ac:  5, thac0: 15, attacks: '1',   damage: '1d10+6',          mv: '9',           tags: ['giant'],   individual: 'S,T',   lairType: 'E' },
  { name: 'Troll',                hd: '6+6',   hp: 33, ac:  4, thac0: 13, attacks: '3',   damage: '1d4+4/1d4+4/2d6', mv: '12',         tags: ['giant'],   individual: 'none',  lairType: 'D',    notes: 'regenerates 3hp/rd; killed only by fire or acid' },
  { name: 'Minotaur',             hd: '6+3',   hp: 30, ac:  6, thac0: 15, attacks: '3',   damage: '2d4/2d4/1d6',    mv: '12',          tags: ['giant'],   individual: 'none',  lairType: 'C' },
  { name: 'Ettin',                hd: '10',    hp: 45, ac:  3, thac0:  9, attacks: '2',   damage: '2d8/2d10',        mv: '12',          tags: ['giant'],   individual: 'S,T',   lairType: 'E',    notes: 'two heads; near-impossible to surprise; can attack two opponents' },
  { name: 'Hill Giant',           hd: '12+2',  hp: 56, ac:  4, thac0:  7, attacks: '1',   damage: '2d8+9',           mv: '12',          tags: ['giant'],   individual: 'S×2,T', lairType: 'E',    notes: 'hurls boulders 2d8 at 200\'' },
  { name: 'Stone Giant',          hd: '14',    hp: 63, ac:  0, thac0:  5, attacks: '1',   damage: '3d10',            mv: '12',          tags: ['giant'],   individual: 'S×2,T', lairType: 'E',    notes: 'hurls boulders 3d10 at 300\'' },
  { name: 'Frost Giant',          hd: '14+1',  hp: 65, ac: -1, thac0:  5, attacks: '1',   damage: '4d6+5',           mv: '12',          tags: ['giant'],   individual: 'S×2,T', lairType: 'E',    notes: 'immune to cold; hurls boulders or icicles (4d6) at 200\'' },
  { name: 'Fire Giant',           hd: '15+1',  hp: 70, ac: -1, thac0:  5, attacks: '1',   damage: '5d6+6',           mv: '12',          tags: ['giant'],   individual: 'S×2,T', lairType: 'H',    notes: 'immune to fire; hurls boulders or lava rocks (5d6) at 200\'' },
  { name: 'Cloud Giant',          hd: '16+2',  hp: 74, ac: -2, thac0:  3, attacks: '1',   damage: '6d6+11',          mv: '15',          tags: ['giant'],   individual: 'T×2',   lairType: 'G',    notes: 'keen smell; hurls rocks or objects (6d6) at 250\'' },
  { name: 'Storm Giant',          hd: '21+1',  hp: 97, ac: -3, thac0:  1, attacks: '1',   damage: '7d10+12',         mv: '15, Sw 15',   tags: ['giant'],   individual: 'T×3',   lairType: 'G',    notes: 'control weather; lightning bolt (15d4); hurls boulders (7d10)' },
  ...
  { name: 'Gargoyle',             hd: '4+4',   hp: 22, ac:  5, thac0: 15, attacks: '4',   damage: '1d3/1d3/1d6/1d4+1', mv: '9, Fl 15', tags: ['monster'], individual: 'none', lairType: 'C', notes: 'hit only by +1 or better weapons; immune: sleep, charm, hold, fear' },
  { name: 'Rust Monster',         hd: '5',     hp: 23, ac:  2, thac0: 15, attacks: '2',   damage: 'rust ferrous metal', mv: '18',        tags: ['monster'], individual: 'none', lairType: 'none', notes: 'touch rusts and destroys any ferrous metal item instantly' },
  { name: 'Beholder',             hd: '45 hp', hp: 57, ac:  0, thac0:  7, attacks: '1+11 eyes', damage: '2d4+eye rays', mv: '3',        tags: ['monster'], individual: 'none', lairType: 'H', notes: '10 eye rays (death, petrify, disintegrate, sleep, slow, etc.) + anti-magic ray' },
  { name: 'Mind Flayer',          hd: '8+4',   hp: 40, ac:  5, thac0: 11, attacks: '4',   damage: '2/2/2/2',         mv: '12',          tags: ['monster'], individual: 'V',    lairType: 'I', notes: 'mind blast cone (stuns); 4 tentacles: extract brain if all hit' },
  ...
  { name: 'White Dragon',         hd: '7+7',   hp: 39, ac:  3, thac0: 13, attacks: '3',   damage: '1d6+1/1d6+1/2d8+1', mv: '9, Fl 30', tags: ['dragon'], individual: 'none', lairType: 'H', notes: 'breath: cold cone (7d10); immune to cold; lair in icy terrain' },
  { name: 'Black Dragon',         hd: '8+8',   hp: 44, ac:  3, thac0: 11, attacks: '3',   damage: '1d4+4/1d4+4/3d6+4', mv: '9, Sw 12, Fl 24', tags: ['dragon'], individual: 'none', lairType: 'H', notes: 'breath: acid line (8d10); immune to acid; swamp lairs' },
  { name: 'Green Dragon',         hd: '9+9',   hp: 50, ac:  1, thac0: 11, attacks: '3',   damage: '1d6+5/1d6+5/2d10+5', mv: '9, Sw 9, Fl 24', tags: ['dragon'], individual: 'none', lairType: 'H', notes: 'breath: chlorine gas cone (9d10); forest lairs' },
  { name: 'Blue Dragon',          hd: '10+10', hp: 55, ac: -1, thac0:  9, attacks: '3',   damage: '1d6+6/1d6+6/3d8+6', mv: '9, Fl 24', tags: ['dragon'], individual: 'none', lairType: 'H', notes: 'breath: lightning bolt (10d10); immune to electricity; desert lairs' },
  { name: 'Red Dragon',           hd: '11+11', hp: 60, ac: -1, thac0:  9, attacks: '3',   damage: '1d8+7/1d8+7/3d10+7', mv: '9, Fl 24', tags: ['dragon'], individual: 'none', lairType: 'H', notes: 'breath: fire cone (11d10+11); immune to fire; mountain lairs' },
  { name: 'Silver Dragon',        hd: '10+10', hp: 55, ac: -1, thac0:  9, attacks: '3',   damage: '2d4+7/2d4+7/5d6+7', mv: '9, Fl 30', tags: ['dragon'], individual: 'none', lairType: 'H', notes: 'breath: cold cone or paralytic gas; polymorph self; spell abilities (F9)' },
  { name: 'Gold Dragon',          hd: '11+11', hp: 60, ac: -2, thac0:  7, attacks: '3',   damage: '2d4+8/2d4+8/6d6+8', mv: '12, Sw 12, Fl 40', tags: ['dragon'], individual: 'none', lairType: 'H', notes: 'breath: fire cone or chlorine gas; polymorph; bless; spell abilities' },
